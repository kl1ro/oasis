...
_start:	
	...
	; dl is a drive number now and we have to protect it from being overwritten.
	; Bios functions may modify it, thus we push.
	push dx
	...
	; to restore dx cause it is most likely overwritten by some bios function
	pop dx
